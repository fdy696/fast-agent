...
down_revision: str | None = "dd788e00562f"
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.CheckConstraint(
            "status IN ('active','archived','deleted')", name="ck_chat_sessions_status"
        ),
    ...
    op.create_table(
        ...
        sa.UniqueConstraint(
            "turn_id", "message_index", name="uq_chat_message_turn_index"
        ),
        sa.ForeignKeyConstraint(
            ["session_id"],
