...
def upgrade() -> None:
    ...
    op.create_index("ix_conversations_user_status_updated", "conversations", ["user_id", "status", "updated_at"])
    ...
    op.create_index(op.f("ix_conversation_messages_user_id"), "conversation_messages", ["user_id"])
    op.create_index(op.f("ix_conversation_messages_run_id"), "conversation_messages", ["run_id"])
    op.create_index("ix_cm_conv_id", "conversation_messages", ["conversation_id", "id"])
    op.create_index("ix_cm_user_created", "conversation_messages", ["user_id", "created_at"])
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(["assistant_message_id"], ["conversation_messages.id"], name="fk_ar_assistant_msg", ondelete="SET NULL"),
    ...
    op.create_index("ix_ar_conv_created", "agent_runs", ["conversation_id", "created_at"])
    ...
    op.create_foreign_key(
        "fk_conversations_summary_until_message_id",
        "conversations",
        "conversation_messages",
    ...
    op.create_table(
        ...
        sa.Column("conversation_id", sa.Integer(), nullable=False),
        sa.Column("run_id", sa.String(64), nullable=False),
        sa.Column("model", sa.String(64), nullable=False, server_default="deepseek-v4-pro"),
    ...
    op.create_index("ix_tu_conv_created", "token_usage", ["conversation_id", "created_at"])
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(["message_id"], ["conversation_messages.id"], name="fk_artifacts_msg_id", ondelete="SET NULL"),
        sa.ForeignKeyConstraint(["source_step_id"], ["agent_steps.id"], name="fk_artifacts_step_id", ondelete="SET NULL"),
    ...
    op.create_index("ix_artifacts_conv_created", "artifacts", ["conversation_id", "created_at"])
